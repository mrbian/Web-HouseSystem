...
require('../../scss/admin/base_protect.scss');
...
$(function () {
    ...
    app.controller('MainCtrl',['$scope','$http',function(scope,$http){
        ...
        scope.attack = function(){
            mapIframe.contentWindow.attackEventFromParent = true;      // 传递消息
        };

        scope.resetMap = function(){
            mapIframe.contentWindow.attackEventFromParent = undefined;      // 重置
            mapIframe.contentWindow.location.reload(true);
        };
